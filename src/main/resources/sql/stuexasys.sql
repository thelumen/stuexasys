...
INSERT INTO `com_single_question` VALUES ('280', '10000000', '第六章', '3', '如果结点A是结点B的双亲，而且结点B有4个兄弟，则结点A的度是（）', '2', '3', '4', '5', 'D');
...
INSERT INTO `com_single_question` VALUES ('295', '10000000', '第六章', '2', '已知二叉树有两个叶子结点，两个度为1的结点，则该树中共有 ( )个结点。', '4', '5', '6', '7', 'D');
...
INSERT INTO `com_single_question` VALUES ('304', '10000000', '第六章', '2', '假定在一棵二叉树中，度为2的结点数为15个，度为1的结点数为31个，则叶子结点数为（）个。', '15', '16', '17', '47', 'B');
INSERT INTO `com_single_question` VALUES ('306', '10000000', '第六章', '1', '二叉树的第k层的结点数最多为(       ).     ', '2k-1 ', '2K+1', '2K-1', '2k-1', 'C');
INSERT INTO `com_single_question` VALUES ('307', '10000000', '第六章', '2', '若有18个元素的有序表存放在一维数组A[19]中，第一个元素放A[1]中，现进行二分查找，则 查找A［3］的比较序列的下标依次为(        )   ', '1，2，3 ', ' 9，5，2，3', '9，5，3', '9，4，2，3', 'D');
...
INSERT INTO `com_single_question` VALUES ('339', '10000000', '第九章', '3', '10、具有12个关键字的有序表，折半查找的平均查找长度（    ）。', ' 3.1     ', '4', '2.5', '5', 'A');
INSERT INTO `com_single_question` VALUES ('340', '10000000', '第二章', '2', '函数substr(“DATASTRUCTURE”，5，9)的返回值为（）。', '“STRUCTURE”', ' “DATA” ', '“ASTRUCTUR” ', '“DATASTRUCTURE”  ', 'A');
...
INSERT INTO `com_single_question` VALUES ('345', '10000000', '第九章', '2', '11、在顺序表（8,11,15,19,25,26,30,33,42,48,50）中，用折半查找法查找关键码值20，需做的关键码比较次数为（ ）。', '3', '4', '5', '6', 'B');
...
INSERT INTO `com_single_question` VALUES ('350', '10000000', '第九章', '1', '4．对长度为n的查找表进行顺序查找，其平均查找长度为（     ）。', '( n+1)/2 ', ' ( n-1)/2 ', 'n/2', '以上答案都不对', 'A');
...
INSERT INTO `com_single_question` VALUES ('353', '10000000', '第九章', '2', '7．对一个有序表（2,6,8,10,16,17,19,26）进行折半查找，当查找关键字为19的记录时，经（   ）次比较查找成功。', '1', '2', '3', '4', 'C');
...
INSERT INTO `com_single_question` VALUES ('356', '10000000', '第九章', '2', '7．设有100个结点的有序表，折半查找时，最大比较次数为（ ）次。', '25', '50', '10', '7', 'D');
INSERT INTO `com_single_question` VALUES ('358', '10000000', '第九章', '3', '1．对一个长度20的有序表进行折半查找，则等概率下查找成功时的平均查找长度为（）', '31/10 ', '35/10    ', '37/10    ', '65/20', 'C');
...
INSERT INTO `com_single_question` VALUES ('361', '10000000', '第九章', '2', '3．对一个有序表（2,6,8,12,16,18,20,24）进行折半查找，当查找关键字为20的记录时，经（  ）次比较查找成功。', '1', '2', '3', '4', 'C');
...
INSERT INTO `com_single_question` VALUES ('365', '10000000', '第九章', '1', '1-1  1.若查找每个记录的概率均等，则在具有n个记录的连续顺序文件中采用顺序查找法查找一个记录，其平均查找长度ASL为(    )。', '(n-1)/2 ', ' n/2', '(n+1)/2      ', 'n', 'C');
...
INSERT INTO `com_single_question` VALUES ('370', '10000000', '第九章', '2', '1-2  4. 下面关于二分查找的叙述正确的是  (    ) ', '表必须有序，表可以顺序方式存储，也可以链表方式存储 ', '表必须有序且表中数据必须是整型，实型或字符型     ', '表必须有序，而且只能从小到大排列', '表必须有序，且表只能以顺序方式存储', 'D');
INSERT INTO `com_single_question` VALUES ('372', '10000000', '第二章', '2', '设一个有序的单链表中有n个结点，现要求插入一个新结点后使得单链表仍然保持有序，则该操作的 时间复杂度为（）。', 'O(log2n)', 'O(1)  ', ' O(n*n)', 'O(n) ', 'D');
...
INSERT INTO `com_single_question` VALUES ('375', '10000000', '第九章', '2', '1-3  7. 用二分（对半）查找表的元素的速度比用顺序法(   ) ', '  必然快   ', ' 必然慢      ', '相等', '不能确定', 'D');
INSERT INTO `com_single_question` VALUES ('376', '10000000', '第二章', '2', '链表不具有的特点是（）。', '插入、删除不需要移动元素', '可随机访问任一元素', '不必事先估计存储空间', '所需空间与线性长度成正比', 'B');
INSERT INTO `com_single_question` VALUES ('377', '10000000', '第二章', '2', '线性表（ a1,a2,…,an）以链接方式存储时，访问第i 位置元素的时间复杂性为（）', 'O（i）', 'O（1）', 'O（n）', 'O（i-1）', 'C');
INSERT INTO `com_single_question` VALUES ('378', '10000000', '第九章', '3', '1-4 8．当在一个有序的顺序存储表上查找一个数据时，即可用折半查找，也可用顺序查找，但前者比后者的查找速度(    )', '必定快    ', '不一定   ', '在大部分情况下要快', '取决于表递增还是递减', 'C');
INSERT INTO `com_single_question` VALUES ('379', '10000000', '第九章', '2', '1-5 9. 具有12个关键字的有序表，折半查找的平均查找长度（ ）', '3.1', '4', '2.5', '5', 'A');
...
INSERT INTO `com_single_question` VALUES ('383', '10000000', '第九章', '1', '13. 要进行顺序查找，则线性表（）；', '必须以顺序方式存储', '必须以链式方式存储；', '既可以以顺序方式存储，也可以链式方式存储；', '必须以顺序方式存储，且数据已按递增或递减顺序排好；', 'C');
...
INSERT INTO `com_single_question` VALUES ('387', '10000000', '第九章', '2', '14．要进行折半查询，则线性表（）；', '必须以顺序方式存储； ', '必须以链式方式存储；', ' 既可以以顺序方式存储，也可以链式方式存储；', '必须以顺序方式存储，且数据已按递增或递减顺序排好；', 'D');
INSERT INTO `com_single_question` VALUES ('388', '10000000', '第九章', '1', '16。若表中元素个数为n,则顺序查找的平均比较次数为（）；', ' n/2   ', '(n+1)/2', 'nlog2n    ', ' log2(n+1)', 'B');
INSERT INTO `com_single_question` VALUES ('390', '10000000', '第九章', '1', '17．折半查找的平均比较次数为（）。 ', 'n/2   B。(n+1)/2    C.nlog2n    D    log2(n+1)', '(n+1)/2 ', 'nlog2n    ', '  log2(n+1)', 'D');
INSERT INTO `com_single_question` VALUES ('393', '10000000', '第九章', '3', '12、下面关于B和B+树的叙述中，不正确的是(    )  。', ' B树和B+树都是平衡的多叉树。    ', 'B树和B+树都可用于文件的索引结构。', ' B树和B+树都能有效地支持顺序检索。', 'B树和B+树都能有效地支持随机检索。', 'C');
INSERT INTO `com_single_question` VALUES ('398', '10000000', '第九章', '3', '1-7  二叉查找树在 ()时其查找效率最低能   ', '结点太多   ', '完全二叉树', ' 呈单枝树', '结点太复杂。', 'C');
INSERT INTO `com_single_question` VALUES ('401', '10000000', '第九章', '3', '2-1 21. 下面关于m阶B-树说法正确的是(  )', '每个结点至少有两棵非空子树', '树中每个结点至多有m一1个关键字;', '所有叶子可以不在同一层上; ', '当插入一个数据项引起B树结点分裂后，树长高一层。', 'B');
INSERT INTO `com_single_question` VALUES ('402', '10000000', '第九章', '3', '2-2  22. 下面关于B和B+树的叙述中，不正确的是(    )', ' B树和B+树都是平衡的多叉树。  ', 'B树和B+树都可用于文件的索引结构。', ' B树和B+树都能有效地支持顺序检索。 ', 'B树和B+树都能有效地支持随机检索。', 'C');
INSERT INTO `com_single_question` VALUES ('403', '10000000', '第九章', '3', '2-3  23. m阶B-树是一棵(    )   ', ' m叉排序树  ', 'm叉平衡排序树', ' m-1叉平衡排序树  ', ' m-1叉平衡排序树', 'B');
INSERT INTO `com_single_question` VALUES ('404', '10000000', '第九章', '2', '6．设二叉排序树中有n个结点，则在二叉排序树的平均平均查找长度为（  ）。 ', ' (A) O(1)', ' O(log2n) ', 'O(n)', 'O(n2) ', 'B');
INSERT INTO `com_single_question` VALUES ('405', '10000000', '第九章', '2', '7．设有序表中有1000个元素，则用二分查找查找元素X最多需要比较（ ）次。', '25', '10', '7', '1', 'B');
INSERT INTO `com_single_question` VALUES ('406', '10000000', '第九章', '3', '13、假定有k个关键字互为同义词，若用线性探测法把这k个关键字存入散列表中，至少要进行多少次探测？(    )   ', 'k-1次   ', 'k次   ', 'k+1次', 'k（k+1）/2次', 'D');
INSERT INTO `com_single_question` VALUES ('407', '10000000', '第九章', '2', '3-1 27. 设有一组记录的关键字为{19，14，23，1，68，20，84，27，55，11，10，79}，用链地址法构造散列表，散列函数为H（key）=key MOD 13,散列地址为1的链中有（ ）个记录。', '1', '2', '3', '4', 'D');
INSERT INTO `com_single_question` VALUES ('408', '10000000', '第九章', '2', '3-2 29. 若采用链地址法构造散列表，散列函数为H（key）=key MOD 17，则需 () 个链表。', '17', '13', '16', '任意', 'A');
INSERT INTO `com_single_question` VALUES ('409', '10000000', '第九章', '2', '30.若采用链地址法构造散列表，散列函数为H（key）=key MOD 17，这些链的链首指针构成一个指针数组，数组的下标范围为 () ', '0至17       ', '1至17       ', '0至16       ', '1至16  ', 'C');
INSERT INTO `com_single_question` VALUES ('410', '10000000', '第九章', '2', '3-5 35. 散列表的地址区间为0-17,散列函数为H(K)=K mod 17。采用线性探测法处理冲突，并将关键字序列26，25，72，38，8，18，59依次存储到散列表中元素59存放在散列表中的地址是（  ）。', '8        ', '9', '10', '11', 'D');
INSERT INTO `com_single_question` VALUES ('411', '10000000', '第九章', '2', '3-5 35. 散列表的地址区间为0-17,散列函数为H(K)=K mod 17。采用线性探测法处理冲突，并将关键字序列26，25，72，38，8，18，59依次存储到散列表中散列表的地址区间为0-17,散列函数为H(K)=K mod 17。采用线性探测法处理冲突，并将关键字序列26，25，72，38，8，18，59依次存储到散列表中。存放元素59需要搜索的次数是（   ）。', '2', '3', '4', '5', 'C');
INSERT INTO `com_single_question` VALUES ('412', '10000000', '第九章', '3', '3-6 36. 将10个元素散列到100000个单元的哈希表中，则（  ）产生冲突。', ' 一定会       ', '一定不会    ', '仍可能会', '以上答案都不对', 'C');
INSERT INTO `com_single_question` VALUES ('413', '10000000', '第九章', '2', '4．若结点的存储地址与其关键字间存在映射关系，则这种存储结构为(    )。', '顺序存储结构 ', '链式存储结构', '哈希散列存储结构  ', '索引存储结构', 'C');
INSERT INTO `com_single_question` VALUES ('414', '10000000', '第九章', '2', '9. 对于线性表（7，34，55，25，64，46，20，10）进行散列存储时，若选用H（K）=K %9作 为散列函数，则散列地址为1的元素有（）个，        ', '1', '2', '3', '4', 'D');
...
INSERT INTO `com_single_question` VALUES ('420', '10000000', '第三章', '2', ' 有六个元素6，5，4，3，2，1 的顺序进栈，问下列哪一个不是合法的出栈序列？', '5 4 3 6 1 2 ', '4 5 3 1 2 6 ', '3 4 6 5 2 1 ', '2 3 4 1 5 6', 'C');
INSERT INTO `com_single_question` VALUES ('421', '10000000', '第三章', '2', '一个栈的输入序列为1 2 3 4 5，则下列序列中不可能是栈的输出序列的是', '2 3 4 1 5 ', '5 4 1 3 2 ', '2 3 1 4 5 ', '1 5 4 3 2', 'B');
...
INSERT INTO `com_single_question` VALUES ('427', '10000000', '第三章', '1', '栈和队列的共同特点是', '栈和队列的共同特点是', '都是先进后出', '都是先进先出', '没有共同点', 'A');
...
INSERT INTO `com_single_question` VALUES ('439', '10000000', '第三章', '2', '设顺序循环队列Q[0：M-1]的头指针和尾指针分别为F和R，头指针F总是指向队头元素的前一位置， 尾指针R总是指向队尾元素的当前位置，则该循环队列中的元素个数为', 'R-F', 'F-R ', '(R-F+M)％M', '(F-R+M)％M', 'A');
INSERT INTO `com_single_question` VALUES ('440', '10000000', '第三章', '3', '用链接方式存储的队列，在进行删除运算时', '仅修改头指针', '仅修改尾指针', '头、尾指针都要修改', '头、尾指针可能都要修改', 'D');
INSERT INTO `com_single_question` VALUES ('441', '10000000', '第三章', '2', '循环队列存储在数组A[0..m]中，则入队时的操作为', 'rear=rear+1', ' rear=(rear+1) mod (m-1)', 'rear=(rear+1) mod m ', 'rear=(rear+1)mod(m+1)', 'D');
...
INSERT INTO `com_single_question` VALUES ('443', '10000000', '第九章', '2', '3-3 31. 设哈希表长为14，哈希函数是H(key)=key%11,表中已有数据的关键字为15，38，61，84共四个，现要将关键字为49的结点加到表中，用二次探测再散列法解决冲突，则放入的位置是(  )  ', '5         ', '6', '7', '9', 'D');
...
INSERT INTO `com_single_question` VALUES ('458', '10000000', '第七章', '1', '要连通具有n个顶点的有向图，至少需要（）条边。', 'n-1', 'n', 'n+1', '2n', 'A');
INSERT INTO `com_single_question` VALUES ('459', '10000000', '第七章', '1', 'n个结点的完全有向图含有边的数目', 'n*n', 'n(n+1)', 'n/2', 'n*(n-1)', 'D');
INSERT INTO `com_single_question` VALUES ('460', '10000000', '第七章', '3', '一个有n个结点的图，最少有（     ）个连通分量，最多有D个连通分量。', '0', '1', 'n-1', 'n', 'B');
INSERT INTO `com_single_question` VALUES ('461', '10000000', '第七章', '3', '在一个无向图中，所有顶点的度数之和等于所有边数（   B ）倍，在一个有向图中，所有顶点的入度之和等于所有顶点出度之和的（  1 ）倍。', '1/2 ', '2', '1', '4', 'B');
INSERT INTO `com_single_question` VALUES ('462', '10000000', '第七章', '3', '设某强连通图中有n个顶点，则该强连通图中至少有（     ）条边。   ', 'n(n-1)  ', 'n+1', ' n', 'n(n+1)', 'C');
INSERT INTO `com_single_question` VALUES ('463', '10000000', '第七章', '2', '设某完全无向图中有n个顶点，则该完全无向图中有（      ）条边。', 'n(n-1)/2 ', ' n(n-1)', 'n2 ', 'n2-1 ', 'A');
INSERT INTO `com_single_question` VALUES ('464', '10000000', '第七章', '1', ' 设有6个结点的无向图，该图至少应有(      )条边才能确保是一个连通图。 ', '5', '6', '7', '8', 'A');
INSERT INTO `com_single_question` VALUES ('465', '10000000', '第七章', '2', '设某无向图中有n个顶点e条边，则该无向图中所有顶点的度之和为（     ）。  ', '(A) n     ', ' (B) e', ' (C) 2n   ', ' (D) 2e', 'D');
INSERT INTO `com_single_question` VALUES ('466', '10000000', '第七章', '2', '若n个顶点的无向图采用邻接矩阵存储方法，则该邻接矩阵为（        ）.', '对称矩阵                        ', ' 一般矩阵  ', ' 对角矩阵', '稀疏矩阵', 'A');
INSERT INTO `com_single_question` VALUES ('467', '10000000', '第七章', '2', '下列哪一种图的邻接矩阵是对称矩阵？（    ）', 'A．有向图                          ', 'B．无向图  ', ' C．AOV网   ', ' D．AOE网', 'B');
INSERT INTO `com_single_question` VALUES ('468', '10000000', '第七章', '2', '设某有向图中有n个顶点，则该有向图对应的邻接表中有（ B ）个表头结点。    ', '(A) n-1  ', '(B) n ', ' (C) n+1 ', ' (D) 2n-1 ', 'B');
INSERT INTO `com_single_question` VALUES ('469', '10000000', '第七章', '2', '设无向图G中有n个顶点e条边，则其对应的邻接表中的表头结点和表结点的个数分别为（     ）。', '(A) n，e ，n ', '(B) e', '(C) 2n，e ', '(D) n，2e ', 'D');
INSERT INTO `com_single_question` VALUES ('470', '10000000', '第七章', '2', '设某有向图的邻接表中有n个表头结点和m个表结点，则该图中有（  ）条有向边。  ', ' (A) n    ', '(B) n-1 ', '(C) m ', ' (D) m-1 ', 'C');
INSERT INTO `com_single_question` VALUES ('471', '10000000', '第七章', '2', ' 下列说法不正确的是（  C  ）。', 'A．图的遍历是从给定的源点出发每一个顶点仅被访问一次', 'B．遍历的基本算法有两种：深度遍历和广度遍历  ', 'C．图的深度遍历不适用于有向图', 'D．图的深度遍历是一个递归过程', 'C');
INSERT INTO `com_single_question` VALUES ('472', '10000000', '第七章', '2', '16无向图G=(V,E),其中：V={a,b,c,d,e,f},E={(a,b),(a,e),(a,c),(b,e),(c,f),(f,d),(e,d)}，对该图进行深度优先遍历，得到的顶点序列正确的是（     ）。', 'A．a,b,e,c,d,f              ', ' B．a,c,f,e,b,d', ' C．a,e,b,c,f,d', ' D．a,e,d,f,c,b', 'D');
INSERT INTO `com_single_question` VALUES ('473', '10000000', '第七章', '2', '设连通图G中的边集E={(a，b)，(a，e)，(a，c)，(b，e)，(e，d)，(d，f)，(f，c)}，则从顶点a出发 可以得到一种深度优先遍历的顶点序列为（    ）。   ', '(A) abedfc', '(B) acfebd  ', ' (C) aebdfc    ', '(D) aedfcb ', 'B');
INSERT INTO `com_single_question` VALUES ('474', '10000000', '第七章', '2', '下面关于求关键路径的说法不正确的是（      ）。', ' A．求关键路径是以拓扑排序为基础的', 'B．一个事件的最早开始时间同以该事件为尾的弧的活动最早开始时间相同', 'C．一个事件的最迟开始时间为以该事件为尾的弧的活动最迟开始时间与该活动的持续时间的差', ' D．关键活动一定位于关键路径上', 'B');
INSERT INTO `com_single_question` VALUES ('475', '10000000', '第七章', '3', '若判断一个AOV网中是否存在环，可通过下列哪种操作（       ）', '(A)深度优先搜索              ', ' (B) 广度优先搜索', '(C)拓朴排序', '(D) 关键路径', 'C');
INSERT INTO `com_single_question` VALUES ('477', '10000000', '第七章', '3', '已知有向图G=(V,E)，其中V={V1,V2,V3,V4,V5,V6,V7}，', 'A．V1,V3,V4,V6,V2,V5,V7   ', 'B．V1,V3,V2,V6,V4,V5,V7', 'C．V1,V3,V4,V5,V2,V6,V7  ', 'D．V1,V2,V5,V3,V4,V6,V7', 'A');
...
INSERT INTO `com_teacher` VALUES ('4', '120403', '827ccb0eea8a706c4c34a16891f84e7b', '贾丹', '女', '副教授', '软件工程', null, null);
INSERT INTO `com_teacher` VALUES ('5', '147258', '827ccb0eea8a706c4c34a16891f84e7b', '姜', '男', 'Nothing To Show', 'Nothing To Show', null, null);
...
INSERT INTO `com_tf_question` VALUES ('222', '10000000', '第六章', '2', '一个森林与一棵二叉树的转换是唯一的。（）', '1');
INSERT INTO `com_tf_question` VALUES ('223', '10000000', '第六章', '3', '将一棵二叉树转换成树后，则该树一定没有右子树。（）', '1');
INSERT INTO `com_tf_question` VALUES ('224', '10000000', '第六章', '3', '任何一棵和树对应的二叉树，其右子树必空。（）', '1');
...
INSERT INTO `com_tf_question` VALUES ('246', '10000000', '第二章', '1', '在顺序表中，逻辑上相邻的元素在物理位置上不一定相邻。', '0');
INSERT INTO `com_tf_question` VALUES ('247', '10000000', '第二章', '2', '顺序存储方式只适用于存储线性表。', '0');
...
INSERT INTO `com_tf_question` VALUES ('255', '10000000', '第九章', '2', 'Binary search applies to both the ordered list and unordered list.', '0');
INSERT INTO `com_tf_question` VALUES ('256', '10000000', '第九章', '2', 'Binary search applies to both sequential storage structure and linked storage structure.', '0');
INSERT INTO `com_tf_question` VALUES ('257', '10000000', '第九章', '2', 'Sequential search applies to both sequential storage structure and linked storage structure.', '1');
INSERT INTO `com_tf_question` VALUES ('258', '10000000', '第九章', '2', 'When binary search the list ,the list must be a ordered list and stored by sequential storage structure.', '1');
INSERT INTO `com_tf_question` VALUES ('259', '10000000', '第九章', '3', 'o different data sequence,the different binary sort tree can be gotten.', '0');
INSERT INTO `com_tf_question` VALUES ('260', '10000000', '第二章', '1', '顺序存储结构的主要缺点是不利于插入或删除操作。', '1');
...
INSERT INTO `com_tf_question` VALUES ('263', '10000000', '第九章', '2', 'To the same data,the shape of created binary sort tree is independent of the inserted sequence.', '0');
...
INSERT INTO `com_tf_question` VALUES ('266', '10000000', '第九章', '2', 'Insert a new node to the binary sort tree,the new node should always be leaf node.', '1');
...
INSERT INTO `com_tf_question` VALUES ('293', '10000000', '第三章', '1', '队列是先进后出的线性表。', '0');
...
INSERT INTO `com_tf_question` VALUES ('311', '10000000', '第九章', '2', '1．折半查找既适用于有序表，也适用于无序表。（    ）', '0');
INSERT INTO `com_tf_question` VALUES ('312', '10000000', '第九章', '2', '2．折半查找既适用于顺序存储结构，也适用于链式存储结构。（ ）', '0');
INSERT INTO `com_tf_question` VALUES ('313', '10000000', '第九章', '2', '67. 折半查找所对应的判定树，既是一棵二叉查找树，又是一棵理想平衡二叉树。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('314', '10000000', '第九章', '2', '98. 顺序查找法适用于存储结构为顺序或链接存储的线性表。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('315', '10000000', '第九章', '2', '119. 在索引顺序结构的搜索中，对索引表既可以采取顺序搜索，也可以采用折半搜索。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('316', '10000000', '第九章', '3', '128. 在索引顺序结构上实施分块搜索，在等概率情况下，其平均搜索长度不仅与子表个数有关，而且与每一个子表中的对象个数有关。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('317', '10000000', '第九章', '1', '45. 顺序查找法适用于存储结构为顺序或链接存储的线性表。（   　）', '1');
INSERT INTO `com_tf_question` VALUES ('318', '10000000', '第九章', '1', '54. 能够在链接存储的有序表上进行折半查找，其时间复杂度与在顺序存储的有序表上相同。(  )', '0');
INSERT INTO `com_tf_question` VALUES ('319', '10000000', '第九章', '2', '127. 进行折半查找的表必须是顺序存储的有序表。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('320', '10000000', '第九章', '3', '1．(      )给出不同的输入序列建造二叉排序树，一定得到不同的二叉排序树。', '0');
INSERT INTO `com_tf_question` VALUES ('321', '10000000', '第九章', '2', '3．平衡二叉树中所有结点的平衡因子都不超过1。（  ）', '1');
INSERT INTO `com_tf_question` VALUES ('322', '10000000', '第九章', '2', '20. 对平衡二叉树进行中根遍历，可得到结点的有序排列。（  ）', '1');
INSERT INTO `com_tf_question` VALUES ('323', '10000000', '第九章', '3', '52. 在一棵B树中，所有叶结点都处在同一层上，所有叶结点中数等于所有关键码的总数加1。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('324', '10000000', '第九章', '2', '76. 对于同一组记录，生成二叉搜索树的形态与插入记录的次序无关。(  )', '0');
INSERT INTO `com_tf_question` VALUES ('325', '10000000', '第九章', '2', '79. 对于两棵具有相同记录集合而具有不同形态的二叉搜索树，按中序遍历得到的结点序列是相同的。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('326', '10000000', '第九章', '2', '91. 对平衡二叉树进行中根遍历，可得到结点的有序序列。（  　）', '1');
INSERT INTO `com_tf_question` VALUES ('327', '10000000', '第九章', '3', '103. 向一棵B树插入关键码的过程中，若最终引起树根结点的分裂，则新树比原树的高度减少1。(  )', '0');
INSERT INTO `com_tf_question` VALUES ('328', '10000000', '第九章', '2', '105. 在二叉排序树中插入新结点时，新结点总是作为叶子结点插入。（  　）', '1');
INSERT INTO `com_tf_question` VALUES ('329', '10000000', '第九章', '1', '10．直接定址法是构造哈希表时的一种处理冲突的方法。(  )', '0');
INSERT INTO `com_tf_question` VALUES ('330', '10000000', '第九章', '1', '15. 哈希查找法中解决冲突问题的常用方法是除留余数法。（  ）', '0');
INSERT INTO `com_tf_question` VALUES ('331', '10000000', '第九章', '2', '36. 装载因子是散列表的一个重要参数，它反映了散列表的装满程度。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('332', '10000000', '第九章', '2', '42.  对于同一组关键码互不相同的记录，若生成二叉搜索树时插入记录的次序不同，则得到不同形态的二叉搜索树。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('333', '10000000', '第九章', '3', '40. 理想情况下哈希查找的等概率查找成功的平均查找长度是O（1）。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('334', '10000000', '第六章', '1', '某个结点的度就是它的孩子数目。', '1');
INSERT INTO `com_tf_question` VALUES ('335', '10000000', '第六章', '1', '如果二叉树中某结点的度为1，则说该结点只有一棵子树。', '1');
INSERT INTO `com_tf_question` VALUES ('336', '10000000', '第六章', '2', '完全二叉树就是满二叉树。', '0');
INSERT INTO `com_tf_question` VALUES ('337', '10000000', '第六章', '3', '如果二叉树中结点总数为K，则该二叉树中分数总数为K+1。', '0');
INSERT INTO `com_tf_question` VALUES ('338', '10000000', '第六章', '3', '先序遍历序列与中序遍历序列相同的二叉树只能是右单支树。', '1');
INSERT INTO `com_tf_question` VALUES ('339', '10000000', '第六章', '2', '一棵树的后序遍历序列与对应二叉树的后序遍历序列相同。', '0');
INSERT INTO `com_tf_question` VALUES ('340', '10000000', '第六章', '2', '一棵树的先序遍历序列与对应二叉树的先序遍历序列相同。', '1');
INSERT INTO `com_tf_question` VALUES ('341', '10000000', '第六章', '2', '若一棵二叉树中的结点均无右孩子，则该二叉树的中根遍历和后根遍历序列正好相反。', '0');
INSERT INTO `com_tf_question` VALUES ('342', '10000000', '第六章', '2', '对二叉排序树进行中根遍历，可得到结点的有序排列。', '1');
INSERT INTO `com_tf_question` VALUES ('343', '10000000', '第六章', '2', '任何一棵二叉树的叶结点在三种遍历中的相对次序是不变的。', '1');
INSERT INTO `com_tf_question` VALUES ('344', '10000000', '第六章', '2', '在一棵二叉树中，假定每个结点只有左子女，没有右子女，对它分别进行前序遍历和中根遍历，则具有相同的结果。', '0');
INSERT INTO `com_tf_question` VALUES ('345', '10000000', '第六章', '1', '二叉树是一棵无序树。', '0');
...
INSERT INTO `com_tf_question` VALUES ('348', '10000000', '第六章', '2', '在线索二叉树中每个结点通过线索都可以直接找到它的前驱和后继。', '0');
INSERT INTO `com_tf_question` VALUES ('349', '10000000', '第六章', '3', '在任意一棵二叉树的前序序列和后序序列中，各叶子之间的相对次序关系都相同。', '1');
INSERT INTO `com_tf_question` VALUES ('350', '10000000', '第六章', '2', '线索二叉树中的每个结点通常包含有5个数据成员。', '1');
...
INSERT INTO `com_tf_question` VALUES ('353', '10000000', '第六章', '3', '将一棵二叉树转换成树后，则该树一定没有右子树。', '1');
INSERT INTO `com_tf_question` VALUES ('354', '10000000', '第六章', '3', '3．	任何一棵和树对应的二叉树，其右子树必空。', '1');
...
INSERT INTO `com_tf_question` VALUES ('361', '10000000', '第七章', '2', '对一个有向图进行拓扑排序，一定可以将图的所有顶点按其关键码大小排列到一个拓扑有序的序列中。(      )', '0');
INSERT INTO `com_tf_question` VALUES ('362', '10000000', '第七章', '2', ' 对任何用顶点表示活动的网络（AOV网）进行拓扑排序的结果都是唯一的。(     )', '0');
INSERT INTO `com_tf_question` VALUES ('363', '10000000', '第七章', '2', ' 拓扑排序是指结点的值是有序排序的。（     ）', '0');
INSERT INTO `com_tf_question` VALUES ('364', '10000000', '第七章', '2', '有回路的有向图不能完成拓扑排序。(  )', '1');
INSERT INTO `com_tf_question` VALUES ('365', '10000000', '第七章', '3', '(  Χ  )如一AOV网是无环的，则由该网得到的拓扑序列是唯一的。', '0');
INSERT INTO `com_tf_question` VALUES ('366', '10000000', '第七章', '1', '1．	有向无环图的拓扑序列是不唯一的。（       ）', '1');
INSERT INTO `com_tf_question` VALUES ('367', '10000000', '第七章', '1', '6．	一个连通网的最小生成树是唯一的。', '0');
INSERT INTO `com_tf_question` VALUES ('368', '10000000', '第七章', '2', '26．连通图上各边权值均不相同，则该图的最小生成树是唯一的。（     ）', '1');
INSERT INTO `com_tf_question` VALUES ('369', '10000000', '第七章', '1', '一个网（带权图）都有唯一的最小生成树。（    ）', '0');
INSERT INTO `com_tf_question` VALUES ('370', '10000000', '第七章', '1', '带权无向图的最小生成树必是唯一的。（    ）', '0');
...
INSERT INTO `com_tf_question` VALUES ('378', '10000000', '第七章', '3', '5．	图的广度优先搜索类似于树的按层次遍历。（     ）', '1');
...
INSERT INTO `com_tf_question` VALUES ('383', '10000000', '第七章', '2', '用邻接矩阵存储一个图时，在不考虑压缩存储的情况下，所占用的存储空间大小只与图中', '1');
...
INSERT INTO `com_tf_question` VALUES ('388', '10000000', '第七章', '1', '十字链表是无向图的一种存储结构。（    ）', '0');
INSERT INTO `com_tf_question` VALUES ('389', '10000000', '第七章', '1', '有向图中顶点V的度等于其邻接矩阵中第V行中的1的个数。（    ）', '0');
INSERT INTO `com_tf_question` VALUES ('390', '10000000', '第七章', '2', '有e条边的无向图，在邻接表中有e个结点。（     ）', '0');
INSERT INTO `com_tf_question` VALUES ('391', '10000000', '第七章', '2', '(         )有向图用邻接矩阵表示后，顶点i的入度等于邻接矩阵中第i列的元素之和。', '1');
INSERT INTO `com_tf_question` VALUES ('392', '10000000', '第七章', '2', '4．	对于一个有向图的逆邻接表，第i个链表中的结点个数为顶点vi的出度。', '0');
INSERT INTO `com_tf_question` VALUES ('393', '10000000', '第七章', '2', '3．	有向图用邻接表表示后，顶点i的出度等于邻接表中第i个单链表中结点个数。(         )', '1');
INSERT INTO `com_tf_question` VALUES ('394', '10000000', '第七章', '2', '2．	有向图用邻接表表示，邻接表中第i个单链表中结点个数等于顶点i的入度。(      )', '0');
INSERT INTO `com_tf_question` VALUES ('395', '10000000', '第七章', '3', '1．	有向图的邻接矩阵一定是不对称的。（    ）', '0');
...
INSERT INTO `com_tf_question` VALUES ('400', '10000000', '第七章', '3', '如果无向图中每个顶点的度都大于等于2，则该图中必有回路。(  )', '1');
...
INSERT INTO `com_tf_question` VALUES ('404', '10000000', '第七章', '3', '如果有向图中各个顶点的度都大于2，则该图中必有回路。(  )', '0');
